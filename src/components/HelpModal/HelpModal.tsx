  ...
  return (
    ...
    >
      <div className={classes.container}>
        ...
        <h3 className={classes.header}>Generating a Master Seed and Shares</h3>
        <ul className={classes.list}>
          ...
          <li>
            If you do not want to rely on your computer to generate random numbers, you can activate the
            advanced toolset to manually enter any entropy that is generated by an external device, such
            as dice or cards.
          </li>
          <li>
            ...
            reconstruct the seed, you can distribute the 5 shares to different locations and only need 3
            of them to reconstruct the seed.
          </li>
          <li>
            Click the "Split" button to generate the shares. You will be presented with your first share,
            and you can use the arrow button to slide through all of them.
          </li>
          <li>
            Use the export button to print as many forms for your seed shares as you need on your printer
            to fill out your shares. The shares are not printed in the forms because otherwise this info
            may remain in the memory of your printer which is putting your master seed at risk.
          </li>
          <li>
        ...
        <Accordion label="Reconstructing a Master Seed">
          <ul>
            <li>
        ...
        <Accordion label="Tips and Best Practices">
          <ul>
            <li>
